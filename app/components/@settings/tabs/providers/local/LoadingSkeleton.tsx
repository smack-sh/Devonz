...
export function ProviderCardSkeleton({ className }: ProviderCardSkeletonProps) {
  return (
    <div className={classNames('bg-devonz-elements-background-depth-2 rounded-xl p-5', className)}>
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-start gap-4 flex-1">
          <div className="w-12 h-12 rounded-xl bg-devonz-elements-background-depth-3 animate-pulse" />
        ...
        <div className="w-10 h-6 bg-devonz-elements-background-depth-3 rounded-full animate-pulse" />
      </div>
    </div>
  );
}
    ...
    <div className={classNames('space-y-6', className)}>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <div className="w-24 h-8 bg-devonz-elements-background-depth-3 rounded-lg animate-pulse" />
          <div className="w-16 h-8 bg-devonz-elements-background-depth-3 rounded-lg animate-pulse" />
        </div>
      </div>
