...
export function GitHubConnectionRequired({ onConnect, className = '' }: GitHubConnectionRequiredProps) {
  return (
    <div className={classNames('flex flex-col items-center justify-center py-12 text-center', className)}>
      <div className="i-ph:github-logo size-12 text-devonz-elements-textTertiary mb-4" />
      <h3 className="text-lg font-medium text-devonz-elements-textPrimary mb-2">GitHub Connection Required</h3>
      <p className="text-sm text-devonz-elements-textSecondary mb-6 max-w-md">
      ...
      {onConnect && (
        <button
          onClick={onConnect}
          className="px-6 py-3 bg-devonz-elements-item-contentAccent text-white rounded-lg hover:bg-devonz-elements-item-contentAccent/90 transition-colors flex items-center gap-2"
        >
