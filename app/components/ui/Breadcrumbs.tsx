      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-devonz-elements-textPrimary dark:text-devonz-elements-textPrimary-dark'
              : 'text-devonz-elements-textSecondary dark:text-devonz-elements-textSecondary-dark hover:text-devonz-elements-textPrimary dark:hover:text-devonz-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-devonz-elements-textTertiary dark:text-devonz-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
