...
const RightIconPanel: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Left fade gradient */}
      <div className="absolute left-0 top-0 bottom-0 w-16 bg-gradient-to-r from-devonz-elements-bg-depth-1 via-devonz-elements-bg-depth-1/80 to-transparent z-[1] pointer-events-none" />
      ...
      {/* Right fade gradient */}
      <div className="absolute right-0 top-0 bottom-0 w-16 bg-gradient-to-l from-devonz-elements-bg-depth-1 via-devonz-elements-bg-depth-1/80 to-transparent z-[1] pointer-events-none" />
    </div>
  );
};
