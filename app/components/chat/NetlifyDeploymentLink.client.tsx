...
export function NetlifyDeploymentLink() {
  ...
  const deployedSite = connection.stats?.sites?.find((site) => site.name.includes(`devonz-diy-${currentChatId}`));
      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          <a
            ...
            className="inline-flex items-center justify-center w-8 h-8 rounded hover:bg-devonz-elements-item-backgroundActive text-devonz-elements-textSecondary hover:text-[#00AD9F] z-50"
            onClick={(e) => {
